    ...
    <div className="mt-5">
      <div className="flex gap-3">
        <button
          ...
          className="border border-primary text-xs font-thin w-[160px] rounded-3xl flex btn-sm items-center"
        >
        ...
        <button
          onClick={handleGoogleSingIn}
          className="hover:bg-transparent border border-primary text-xs font-thin w-[160px] rounded-3xl flex btn-sm items-center "
        >
          <div className="mx-auto flex items-center">
