              ...
              <Link to="/">
                ...
                <div className="    z-50 top-32  mx-10  rounded-2xl">
                    <div className="relative md:w-[600px] w-[300px]">
                        <input onChange={(event)=>setSearchText(event.target.value)} type="text"  placeholder="Search for friend, post or video" className="border rounded-2xl p-2 bg-transparent border-cyan-100  pr-16 text-white::placeholder  placeholder-white w-full"  required/>
                        <button onClick={handleSearch} className="  bg-transparent hover:none absolute top-2 rounded-2xl right-0 "><FaSistrix className="w-16 text-cyan-100 h-8"/></button>
                    </div>
                </div>
