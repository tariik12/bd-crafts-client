            ...
            <div className="card px-5 w-full  max-w-sm shadow-2xl bg-[#f0dcdc55]">
                ...
                <form onSubmit={handleFormSubmit}  className="card-body ">
                    ...
                    <input type="text" 
                        ...
                        placeholder="enter a room code" className="bg-transparent placeholder:text-black w-full border-b border-primary  focus:outline-none rounded-xl  p-3" />
                    ...
                    <button className="btn btn-primary btn-sm"><Link to="/">Back to home</Link></button>
                </form>
